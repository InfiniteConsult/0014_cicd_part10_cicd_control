...
This file contains the classes required for the fixtures and type hinting and not the fixtures themselves. We define
them here in order to easily import the definitions in tests without making the tests folder a package.
"""
import re
import socket
import ssl
